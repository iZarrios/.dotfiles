...
local get_hostname = (function()
  ...
  return function()
    ...
    cached_hostname = string.gsub(hostname, "\n$", "")
    return cached_hostname
  end
end)()

--- Applies a configuration function based on the current hostname.
--- @param opts table -- Table containing optional 'biluka' and 'pavi' keys
--- @option opts.biluka? fun(): nil -- Configuration function for "biluka"
--- @option opts.pavi? fun(): nil   -- Configuration function for "pavi"
local function apply_invariant(opts)
  local hostname = get_hostname()
  if not hostname then
    return
  end

  local config_func = opts[hostname]
  if config_func then
    config_func()
  end
end
...
hl.config({
  general = {
    ...
    col              = {
      ...
      inactive_border = "rgba(89,89,89,0.67)",
    },
